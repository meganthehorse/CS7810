...
# Prefixes
name_space = "http://www.semanticweb.org/soloflife/"
pfs = {
...
for name in distance_df['Name']:  # for each name row 
    ...
    output_file = os.path.join(output_path, f"{name}.ttl")
